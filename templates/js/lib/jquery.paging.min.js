...
typeof a)try{a=n.parseJSON(a)}catch(m){return}b.a.onRefresh(a)}})},1E3*b.a.refresh.interval));b.format=function(a){for(var b=0,g=0,h=1,e={d:[],g:0,f:0,b:5,current:3,i:0,j:0},c,p=/[*<>pq\[\]().-]|[nc]+!?/g,n={"[":"first","]":"last","<":"上一页",">":"下一页",q:"left",p:"right","-":"fill",".":"leap"},f={};c=p.exec(a);)c=""+c,r===n[c]?"("===c?g=++b:")"===c?g=0:h&&("*"===c?(e.g=1,e.f=0):(e.g=0,e.f="!"===c.charAt(c.length-1),e.b=c.length-e.f,(e.current=1+c.indexOf("c"))||(e.current=1+e.b>>1)),e.d[e.d.length]=
